...
public class WritePostPage extends Page {
    ...
    public String writePostGet(Model model) {
        model.addAttribute("postFields", new PostFields());
        return "WritePostPage";
    }

    @AnyRole({Role.Name.WRITER, Role.Name.ADMIN})
    @PostMapping("/writePost")
    public String writePostPost(@Valid @ModelAttribute("postFields") PostFields postFields,
        ...
        userService.writePost(getUser(httpSession), postFields);
