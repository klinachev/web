...
public class UserService {
    ...
    public void writePost(User user, PostFields postFields) {
        Post post = new Post(postFields);
        for (Tag tag : post.getTags()) {
            Tag inRepo = tagRepository.findByName(tag.getName());
            if (inRepo != null) {
                tag.setId(inRepo.getId());
            } else {
